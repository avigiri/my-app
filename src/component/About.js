        ...
        <div>
            ...
            <div className='row'>
                <div className='col-md-6'>
                 <div className='text'>
                    asdfasf
                  <div className='box btn btn-danger'>
                    <a href='#' className='btn btn-danger pt-5 px-5 pb-4'>
                       sdfsadf
                    </a>
                  </div>
                 </div>
                ...
                <div className='col-md-6'>
                     <div className='imgs'>
                      <img src='https://www.geeksforgeeks.org/wp-content/uploads/2020/04/geeksforgeeks-logo-1.png' alt=''/>
                     </div>
                </div>
            </div>
